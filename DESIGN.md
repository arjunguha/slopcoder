...
- Left-pane host/environment/task tree nodes are keyed by stable IDs (`host`, `host::environment`, `task.id`) to avoid remount flicker while polled data objects are replaced.
